<script>
	  ...
	  <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
		<div class="pt-32 sm:pt-0">
		  <h2 class="font-semibold text-4xl text-blueGray-600">
			Hubly - Solutions for your business.
		  </h2>
		  <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
			We offer advice and solutions for your business. We translate our passion into code.
		  </p>
		  <div class="mt-12">
			<a
			  href="https://forms.gle/GtxDnSLuJFhmkoRJA"
			  target="_blank"
			...
			<a
			  href="https://github.com/hubly-it/hubly-it.github.io"
			  ...
			  <div class="relative flex flex-col mt-4">
				<div class="px-4 py-5 flex-auto">
				  ...
				  <p class="mb-4 text-blueGray-500">
					Hubly comes with a huge number of Fully Coded CSS
					components.
				  </p>
				</div>
			  </div>
			...
			<div class="w-full md:w-6/12 px-4">
			  <div class="relative flex flex-col min-w-0 mt-4">
				<div class="px-4 py-5 flex-auto">
				  ...
				  <h6 class="text-xl mb-1 font-semibold">Hubspot Components</h6>
				  <p class="mb-4 text-blueGray-500">
					Thanks to our experience on Hubspot we can offer custom ready-to-use solutions.
				  </p>
				</div>
			  </div>
			  <div class="relative flex flex-col min-w-0">
	...
	<div class="container mx-auto overflow-hidden pb-20">
	  <div class="flex flex-wrap items-center">
		<div class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
		  ...
		  <a
			href="https://github.com/hubly-it"
			target="_blank"
  ...
  <section class="py-0 bg-blueGray-600 overflow-hidden">
	  ...
	  <div class="flex flex-wrap justify-center">
		<div class="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64">
		  ...
		  <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-400">
			Since we are developers, we also love open-source solutions. We actively contribute to threads on Hubspot's slack channel, check out solutions proposed by the community on the main forum... what can I say, get on board. 
		  </p>
