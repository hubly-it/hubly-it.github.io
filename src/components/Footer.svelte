    ...
    <div class="flex flex-wrap text-center lg:text-left">
      <div class="w-full lg:w-6/12 px-4">
        ...
        <div class="mt-6 lg:mb-0 mb-6">
          ...
          <a href="https://forms.gle/HbYt7f859og5k7599" target="_blank">
            <button
              class="bg-white text-red-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
              type="button"
            >
              <i class="fas fa-envelope"></i>
            </button>
          </a>
          <a href="https://github.com/hubly-it" target="_blank">
            <button
